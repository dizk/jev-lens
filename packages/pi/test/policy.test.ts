...
describe("rebuildLedger", () => {
	it("later entries win and applied never regresses to pending", () => {
		const entries = [
			{ type: "custom", customType: "jev-lens", data: { kind: "decision", decision: decision("a", "forget", "pending") } },
			{ type: "custom", customType: "jev-lens", data: { kind: "decision", decision: decision("a", "forget", "applied") } },
			{ type: "custom", customType: "jev-lens", data: { kind: "decision", decision: decision("a", "forget", "pending") } },
